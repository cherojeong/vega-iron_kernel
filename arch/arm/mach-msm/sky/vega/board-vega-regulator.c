...
VREG_CONSUMERS(L2) = {
	...
	REGULATOR_SUPPLY("dsi1_pll_vdda",	"mipi_dsi.1"), /* VREG_L2_1P2 */
#endif
#ifdef CONFIG_AS0260
	REGULATOR_SUPPLY("mipi_csi_vdd",	"4-a090"),
#endif
};
VREG_CONSUMERS(L3) = {
...
//#ifdef CONFIG_FB_MSM_MIPI_SONY_CMD_720P_PT
//	REGULATOR_SUPPLY("ext_3p3v",		"mipi_dsi.1"), 
//#else
...
#ifdef CONFIG_FB_MSM_MIPI_SONY_CMD_720P_PT
	REGULATOR_SUPPLY("dsi_vddi",	"mipi_dsi.1"), /* VREG_L21_1P8 */
#endif
};
VREG_CONSUMERS(L22) = {
...
apq8064_rpm_regulator_init_data[] __devinitdata = {
...
#ifdef CONFIG_FB_MSM_MIPI_SONY_CMD_720P_PT
	RPM_LDO(L11, 0, 1, 0, 3300000, 3300000, NULL,          0,     0), /* VREG_L11_3P3/TOUCH_3P3 */
#else
	...
	RPM_LDO(L21, 0, 1, 0, 1800000, 1800000, NULL,          0,     0), /* VREG_L21_1P8 */
