...
#define JACK_DETECT_GPIO PM8921_GPIO_PM_TO_SYS(38)
...
#if defined(CONFIG_SND_SOC_TPA2028D) || defined(CONFIG_SND_SOC_YDA165)
			set_amp_gain(SPK_ON);
#else
...
static const struct snd_soc_dapm_route apq8064_common_audio_map[] = {
...
#if !defined(CONFIG_MACH_APQ8064_VEGA)
	/************   Analog MIC Paths  ************/
#ifdef CONFIG_SND_SOC_DUAL_AMIC
	/* Handset Mic */
	...
	{"MIC BIAS1 External", NULL, "Handset Mic"},	
#endif /* CONFIG_MACH_APQ8064_VEGA) */
};
...
static const struct snd_soc_dapm_route apq8064_vega_audio_map[] = {
	{"AMIC3", NULL, "MIC BIAS3 External"},
	{"MIC BIAS3 External", NULL, "Handset Mic"},
...
static int msm_audrx_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	apq8064_hs_detect_use_gpio = -1; /* force MBHC mechanical switch available APQ8064 */
