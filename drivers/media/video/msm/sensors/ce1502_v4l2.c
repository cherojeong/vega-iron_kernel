...
#define CE1502_83_FW_MINOR_VER	10//9//8//7//240//5//4// 2
#define CE1502_83_PRM_MAJOR_VER	83//9//83//4//83
#define CE1502_83_PRM_MINOR_VER	10//1//9//8//7//240//5//1//4// 2

#define CE1502_87_FW_MAJOR_VER	87
#define CE1502_87_FW_MINOR_VER	2//236
...
#define CE1502_QTR_SIZE_WIDTH     					1280  
#define CE1502_QTR_SIZE_HEIGHT    					960   
...
static struct msm_sensor_output_info_t ce1502_dimensions[] = {
    ...
    {
        .x_output = CE1502_JPEG_ZSL_SIZE_WIDTH,
        .y_output = CE1502_JPEG_ZSL_SIZE_HEIGHT,
	...
	const struct i2c_device_id *id)
{
	...
	if (s_ctrl->sensor_i2c_client == NULL) {
		printk(KERN_ERR "%s : sensor_i2c_client is NULL\n",__func__);
		return -EFAULT;
	}
...
#ifdef F_CE1502_POWER
	.sensor_power_up = ce1502_sensor_power_up,
	.sensor_power_down = ce1502_sensor_power_down,
#else
