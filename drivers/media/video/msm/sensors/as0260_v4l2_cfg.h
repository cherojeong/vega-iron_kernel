 ...
 *
 */
#ifndef __AS0260_V4L2_CFG_H
#define __AS0260_V4L2_CFG_H
...
static struct msm_camera_i2c_reg_conf as0260_start_settings[] = {
	/* LOGICAL_ADDRESS_ACCESS [SYSMGR_NEXT_STATE] */
	{0x098E, 0xDC00}, 
	/*SYSMGR_NEXT_STATE*/
	{0xDC00, 0x34, MSM_CAMERA_I2C_BYTE_DATA, 0, 0},
	/* COMMAND_REGISTER*/
	{0x0080, 0x8002},
	{
		AS0260_COMMAND_REGISTER, 
		AS0260_COMMAND_REGISTER_SET_STATE,
